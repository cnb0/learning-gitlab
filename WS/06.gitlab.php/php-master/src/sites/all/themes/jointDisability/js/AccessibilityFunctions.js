...
$(document).ready(function() {
	...
	if (language == "he") {
		$("body").prepend('<div class="accessibility-wrapper"><input type="image" class="accessibility-button"  src="'+IMAGES_PATH+'/joint-accessability.png" alt="תפריט נגישות סגור, לחץ אנטר לפתיחה."></input><div id="colorAndFontsButtons" style="display:none"><ul><!--<li><input type="image" id="biggerFont" class="bigger" src="'+IMAGES_PATH+'/disability-06.png" alt="לחץ להגדלת הטקסט" /><label for="biggerFont" tabindex="0">הגדלת הטקסט</label></li><li><input type="image" id="resetFont" class="reset" src="'+IMAGES_PATH+'/disability-07.png" alt="לחץ לאיפוס גודל הטקסט" title=""/><label for="resetFont" tabindex="0" >הקטנת הטקסט</label></li><li><input type="image" id="btnMagnifyingGlassForText" src="'+IMAGES_PATH+'/disability-magnifying.png" title="לחץ להגדלת הטקסט בעזרת זכוכית מגדלת"  alt="זכוכית מגדלת"/><label id="btnMagnifyingGlassForText_label" for="btnMagnifyingGlassForText">זכוכית מגדלת</label></li>--><li><input type="image" src="'+IMAGES_PATH+'/contrast-03.png" id="black" alt="שינוי הרקע לכהה" title="" /><label for="black">שינוי הרקע לכהה</label></li><li><input type="image" id="nornal" src="'+IMAGES_PATH+'/OriginalColors.png"  alt="חזרה לצבעים מקוריים" title="" /><label for="nornal">חזרה לצבעים מקוריים</label></li><li><input type="image" src="'+IMAGES_PATH+'/font_arial.png" id="arial-font" alt="שינוי לפונט קריא"  /><label for="arial-font">שינוי לפונט קריא</label></li><li><input type="image" src="'+IMAGES_PATH+'/font_default.png" id="reset-font-style" alt="חזרה לפונט מקורי" /><label for="reset-font-style">חזרה לפונט מקורי</label></li><li><input type="image" src="'+IMAGES_PATH+'/disa-02.png" id="accessibleSlider" alt="הנגשת הסליידר" /><label id="accessibleSlider_label" for="accessibleSlider">הנגשת הסליידר</label></li><li><input type="image" src="'+IMAGES_PATH+'/disa-03.png" id="accessibleLinks" alt="הדגשת לינקים" /><label id="accessibleLinks_label" for="accessibleLinks">הדגשת לינקים</label></li><!--<li><a href="'+STATEMENT_PATH+'">הצהרת נגישות</a></li>--></ul></div></div>');
	}
	else {
		$("body").prepend('<div class="accessibility-wrapper"><input type="image" class="accessibility-button" src="'+IMAGES_PATH+'/joint-accessability.png" alt="Accessibility menu closed, Press Enter to open."></input><div id="colorAndFontsButtons" style="display:none"><ul><!--<li><input type="image" id="biggerFont" class="bigger" src="'+IMAGES_PATH+'/disability-06.png" alt="Click to increase text size" /><label for="biggerFont" tabindex="0">Increase text size</label></li><li><input type="image" id="resetFont" class="reset" src="'+IMAGES_PATH+'/disability-07.png" alt="Click to reset text size"/><label for="resetFont" tabindex="0" >Decrease text size</label></li><li><input type="image" id="btnMagnifyingGlassForText" src="'+IMAGES_PATH+'/disability-magnifying.png" alt="Click to enlarge the text with a magnifying glass"/><label id="btnMagnifyingGlassForText_label" for="btnMagnifyingGlassForText" tabindex="0">Magnifying glass</label></li>--><li><input type="image" src="'+IMAGES_PATH+'/contrast-03.png" id="black" alt="Change background to dark mode" /><label for="black">Dark mode</label></li><li><input type="image" id="nornal" src="'+IMAGES_PATH+'/OriginalColors.png" alt="Back to original colors" /><label for="nornal">Back to original colors</label></li><li><input type="image" src="'+IMAGES_PATH+'/font_arial.png" id="arial-font" alt="Change to readable font"/><label for="arial-font">Change to readable font</label></li><li><input type="image" src="'+IMAGES_PATH+'/font_default.png" id="reset-font-style" alt="Back to original font" /><label for="reset-font-style">Back to original font</label></li><li><input type="image" src="'+IMAGES_PATH+'/disa-02.png" id="accessibleSlider" alt="accessible Slider" /><label id="accessibleSlider_label" for="accessibleSlider">Accessible Slider</label></li><li><input type="image" src="'+IMAGES_PATH+'/disa-03.png" id="accessibleLinks" alt="Highlighting links" /><label id="accessibleLinks_label" for="accessibleLinks">Highlighting links</label></li><!--<li><a href="'+STATEMENT_PATH+'">Accessibility Statement</a></li>--></ul></div></div>');
	}
	...
	$("#accessibleSlider").click(function () {
		if (!$("."+SLIDER_CLASS).hasClass("accessible_slider")) {
			...
			$('.slides.accessible_slider_ul a').removeAttr('tabindex');
