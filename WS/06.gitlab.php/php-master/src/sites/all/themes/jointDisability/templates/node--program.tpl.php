...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div class="content"<?php print $content_attributes; ?>>
    ...
    <div hidden id = "development_level"><?php print $content['field_development_level'][0]['#markup'];?></div>
    <div hidden id = "field_population_count"><?php print $content['field_population_count'][0]['#markup']; ?></div>
    ...
    <div class="container" id="program_tab_views">
        <ul class="nav vertical-tabs-list col-md-3">
            ...
            <?php endif;?>
            <?php if (isset($content['field_tab_2'][0]['#markup']) && $content['field_tab_2'][0]['#markup'] != ''): ?>
                <li><a data-toggle="tab" href="#field_tab_2"><?php echo $content['field_tab_2']['#title']; ?></a></li>
            <?php endif;?>
            <?php if (isset($content['field_tab_3'][0]['#markup']) && $content['field_tab_3'][0]['#markup'] != ''): ?>
