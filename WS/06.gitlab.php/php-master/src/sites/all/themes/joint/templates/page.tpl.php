...
<div class="main-container container">
  ...
  <div class="row page-content">
    ...
    <?php if (!empty($page['sidebar_first']) && $node->type != 'program' && $node->type != 'area'): ?>
      <aside class="col-sm-3" role="complementary">
        <?php print render($page['sidebar_first']); ?>
      </aside>  <!-- /#sidebar-first -->
    <?php endif; ?> 
	
	 <?php if (!empty($page['sidebar_second']) && $node->type != 'program' && $node->type != 'area'): ?>
    ...
    <section
      <?php 
		...
		if ($node->type == 'program' || $node->type == 'area')
